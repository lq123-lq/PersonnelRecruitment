				...
				<div class="col-xs-3">
					<div class="">
						...
						<ul class="hg-menu-left-list">
							...
							<li class="active"><a href="${pageContext.request.contextPath }/findResumeByUser?id=${USER_SESSION.id}">
								<span class="fa fa-angle-double-right pull-right" aria-hidden="true"></span> 
				...
				<div class="col-xs-9">
					<div class="col-xs-12 border-bottom-e4">
						<div class="col-xs-3 h50 padding-0 margin-top margin-bottom-5">
							<h3 class="ml-sm font-00bff3">我投递的简历</h3>
						</div>
						<div
					...
					<div class="col-xs-12 titext mb-xl">
						<div class="hg-article">
								...
								<c:if test="${empty resumes }">
									<p>您还没有投递过简历哦，去<a href="${pageContext.request.contextPath }/index">首页</a>看看有没有感兴趣的岗位吧~~</p>
								</c:if>
									...
									<c:if test="${!empty resumes }">
										 ...
										 <a href="${pageContext.request.contextPath }/viewResumeById_u?id=${list.rId }">
										 <input type="hidden" name="id" value=${list.rId }>
									      <b>${list.jobName }</b> (${list.collegeName })   / <span><fmt:formatDate value="${list.create_time}" type="date"/></span>
									     </a>
									     </li>
									     </c:forEach>
  									</c:if> 
