		...
		<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4">
					<h4 class="fs-20 font-w600 mb-0 me-auto">修改用人需求</h4>
					<a href="javascript:history.back(-1)" class="btn btn-primary me-3 btn-sm"> 返回 </a>
				</div>
				<div class="row">
					<div class="col-xl-12">
					<form action="${pageContext.request.contextPath }/modifyRequire?id=${job.id}" method="post">
						<div class="card">
							<div class="card-body">
								<div class="row">
								<%-- <input type="hidden" name="title" value="${job.title }">
								<input type="hidden" name="salary" value="${job.salary }">
								<input type="hidden" name="staffName" value="${job.staffName }">
								<input type="hidden" name="tel" value="${job.tel }">
								...
								<input type="hidden" name="createTime" value="${job.createTime }"> --%>
									...
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">最低学历 <span class="text-danger scale5 ms-2">*</span></label>
									...
									<div class="col-xl-12 mb-4">
										...
										<select class="form-select form-control solid" name="status"  value="${job.status }">
										  <option value="2" <c:if test="${job.status==2 }">selected</c:if>>提交中</option>
