                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							...
							<form action="${pageContext.request.contextPath }/findNoticeByTitle_list" method="get">
							<div class="nav-item d-flex align-items-center">
								<div class="input-group search-area">
									<input type="text" class="form-control" name="title" placeholder="请输入要查找的标题">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li class="mm-active"><a href="${pageContext.request.contextPath }/findAllNotice" class="mm-active">公告列表</a></li>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600 me-auto">公告信息列表</h4>
					<div>
							...
							<div id="example5_wrapper" class="dataTables_wrapper no-footer"><table class="table display mb-4 dataTablesCard job-table table-responsive-xl card-table dataTable no-footer" id="example5" role="grid" aria-describedby="example5_info">
								...
								<c:if test="${!empty noticeList }">
									<c:forEach items="${noticeList }" var="notice">
										<tr>
										<td>${notice.title }</td>
										<td class="text-center"><fmt:formatDate value="${notice.createTime}" type="both"/></td>
										
										<c:if test="${notice.status==1 }">
											<td>
											<span class="badge badge-success badge-lg light" _msthash="903643" _msttexthash="5596253">活跃</span>
											</td>
										</c:if>
										<c:if test="${notice.status==0 }">
											<td>
											<span class="badge badge-danger badge-lg light" _msthash="903645" _msttexthash="5069792">结束</span>
											</td>
										</c:if>
										<td>
										<div class="action-buttons d-flex justify-content-end">
											<a href="${pageContext.request.contextPath }/findNoticeById_v?id=${notice.id}" class="btn btn-success light mr-2">
											...
											<a href="${pageContext.request.contextPath }/findNoticeById?id=${notice.id}" class="btn btn-secondary light mr-2">
											...
											<a href="${pageContext.request.contextPath }/delNotice?id=${notice.id}" class="btn btn-danger light">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<rect x="0" y="0" width="24" height="24"></rect>
