            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li class="mm-active"><a href="${pageContext.request.contextPath }/findCollegeUserById_v?id=${COLLEGEUSER_SESSION.id}" class="mm-active">查看个人信息</a></li>
		...
		<div class="content-body" style="min-height: 884px;">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600  me-auto">查看信息</h4>
					<a href="${pageContext.request.contextPath }/findCollegeUserById?id=${collegeUser.id}" class="btn btn-primary me-3 btn-sm">
						编辑
					</a>
								...
								<div class="col-md-8">
									<div class="user d-sm-flex d-block pe-md-5 pe-0">
										<div class="ms-sm-3 ms-0 me-md-5 md-0">
											<h5 class="mb-1 font-w600">${collegeUser.staffName }</h5>
											<div class="listline-wrapper mb-2">
												<span class="item"><i class="far fa-envelope"></i>${collegeUser.email }</span>
												<span class="item"><i class="fa fa-phone" aria-hidden="true"></i>${collegeUser.tel }</span>
												<span class="item"><i class="fas fa-map-marker-alt"></i>${collegeUser.collegeName }</span>
											</div>
											<p></p>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-xl-6 col-md-6">
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">教师职工号 : </span>
											<span class="font-w400">${collegeUser.staffCode }</span>
										</p>
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">教师姓名 : </span>
											<span class="font-w400">${collegeUser.staffName }</span>
										</p>
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">教师性别 : </span>
											<span class="font-w400">${collegeUser.sex }</span>
										</p>
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">所属学院或部门 : </span>
											<span class="font-w400">${collegeUser.collegeName }</span>
										</p>
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">手机号码 : </span>
											<span class="font-w400">${collegeUser.tel }</span>
										</p>
										<p class="font-w600 mb-2 d-flex">
											<span class="custom-label-2">邮箱 : </span>
											<span class="font-w400">${collegeUser.email }</span>
										</p>	
									</div>
									...
									<span class="d-block mb-1">
										<i class="fas fa-circle me-2"></i>
											<c:if test="${collegeUser.status==0 }">
												<span class="font-w400">该账号已禁用</span>
											</c:if>
											<c:if test="${collegeUser.status==1 }">
												<span class="font-w400">该账号已启用</span>
											</c:if>
									</span>
									<span>
										<i class="fas fa-circle me-2"></i>
