				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="true">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="${pageContext.request.contextPath }/findAllCollegeUser" class="mm-active">管理员列表</a></li>						
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li class="mm-active"><a href="${pageContext.request.contextPath }/findCollegeUserById?id=${COLLEGEUSER_SESSION.id}" class="mm-active">修改个人信息</a></li>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                     ...
                     <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="${pageContext.request.contextPath }/findCollegeUserById_v?id=${COLLEGEUSER_SESSION.id}">查看个人信息</a></li>
                            <li><a href="${pageContext.request.contextPath }/findCollegeUserById?id=${COLLEGEUSER_SESSION.id}" class="mm-active">修改个人信息</a></li>
                            <li><a href="${pageContext.request.contextPath }/findCollegeUserById_pwd?id=${COLLEGEUSER_SESSION.id}">修改密码</a></li>
                        </ul>
                    </li>             
                </ul>				
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600 me-auto">编辑个人信息</h4>
				...
				<div class="row">
					<div class="col-xl-12">
					<div class="auth-form">
					<form action="${pageContext.request.contextPath }/modifyCollegeUser?id=${collegeUser.id }" method="post">
					<div style="width: 500px;position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="sex" class="form-control" value="${collegeUser.sex }">
                                	<option value="男" <c:if test="${collegeUser.sex=='男' }">selected</c:if> >男</option>
                                	<option value="女" <c:if test="${collegeUser.sex=='女' }">selected</c:if> >女</option>
                                </select>
                            </div>
                            <div class="mb-3">
