				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li class="mm-active"><a href="${pageContext.request.contextPath }/toAddNotice" class="mm-active">发布公告</a></li>
                        </ul>
                    </li> 
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600 me-auto">发布公告</h4>
				...
				<div class="row">
					...
					<div style="width: 500px;position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);">
                            <div class="mb-3">
                                <label class="mb-1"><strong>标题</strong></label>
                                <input type="text" class="form-control" name="title" placeholder="请输入标题">
                            </div>
                            <div class="mb-3">
                                <label class="mb-1"><strong>内容</strong></label>
                                <textarea id="content" class="form-control solid" aria-label="With textarea" cols="100" name="info"></textarea>
                            </div>
