		...
		<div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4">
					<h4 class="fs-20 font-w600 mb-0 me-auto">修改招聘信息</h4>
				...
				<div class="row">
					<div class="col-xl-12">
					<form action="${pageContext.request.contextPath }/modifyJob?id=${job.id}" method="post">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-xl-12 mb-4">
									  <label class="form-label font-w600">标题 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="text" class="form-control solid" name="title" value="${job.title }">
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">岗位名称 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="text" class="form-control solid" name="jobName" value="${job.jobName }">
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">招聘人数 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="text" class="form-control solid" name="number" value="${job.number }">
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
										<label class="form-label font-w600">岗位类型 <span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="jobType" value="${job.jobType }">
									...
									<div class="col-xl-12 mb-4">
										...
										<textarea class="form-control solid" aria-label="With textarea" name="jobInfo">${job.jobInfo }</textarea>
									</div>
									<div class="col-xl-12 mb-4">
										<label class="form-label font-w600">薪资福利</label>
										<textarea class="form-control solid" aria-label="With textarea" name="salary">${job.salary }</textarea>
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">性别 <span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="sex" value="${job.sex }">
										  <option selected>${job.sex }</option>
									...
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">年龄 <span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="age" value="${job.age }">
										  <option selected>${job.age }</option>
									...
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">学历 <span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="degree" value="${job.degree }">
										  <option selected>${job.degree }</option>
									...
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">工作经验 <span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="experience" value="${job.experience }">
									...
									<div class="col-xl-12 mb-4">
										...
										<textarea class="form-control solid" aria-label="With textarea" name="condition">${job.condition }</textarea>
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">联系人 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="text" class="form-control solid" placeholder="输入联系人姓名" name="staffName" value="${job.staffName }">
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">手机号码 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="tel" class="form-control solid" placeholder="输入联系方式" name="tel" value="${job.tel }">
									</div>
									<div class="col-xl-6  col-md-6 mb-4">
									  <label class="form-label font-w600">邮箱 <span class="text-danger scale5 ms-2">*</span></label>
										<input type="email" class="form-control solid" placeholder="输入邮箱" name="email" value="${job.email }">
									</div>	
									<div class="col-xl-6  col-md-6 mb-4">
										<label class="form-label font-w600">状态<span class="text-danger scale5 ms-2">*</span></label>
										<select class="form-select form-control solid" name="status"  value="${job.status }">
										  <option value="1" <c:if test="${job.status==1 }">selected</c:if>>激活</option>
										  <option value="0" <c:if test="${job.status==0 }">selected</c:if>>结束</option>
										</select>
									</div>				
								</div>
							</div>
