				...
				<div class="col-xs-3">
					<div class="">
						...
						<ul class="hg-menu-left-list">
							...
							<li class="active"><a href="${pageContext.request.contextPath }/findUserById?id=${USER_SESSION.id}">
								<span class="fa fa-angle-double-right pull-right" aria-hidden="true"></span> 
				...
				<div class="col-xs-9">
					<div class="col-xs-12 border-bottom-e4">
						<div class="col-xs-3 h50 padding-0 margin-top margin-bottom-5">
							<h3 class="ml-sm font-00bff3">修改个人信息</h3>
						</div>
						<div
					...
					<c:if test="${!empty USER_SESSION }">
						<form action="${pageContext.request.contextPath }/modifyUser?id=${user.id }" method="post">
					<div class="card">
								...
								<br><br><div class="row">
									<div class="col-xl-6 col-md-6">
										<p class="font-w600 mb-2 d-flex">
											...
											<input type="text" class="form-control" name="usercode" value="${user.usercode }" />
										</p>
										<p class="font-w600 mb-2 d-flex">
										...
										<p class="font-w600 mb-2 d-flex">
											...
											<select name="sex" class="form-control" value="${user.sex }">
									...
									<div class="col-xl-6 col-md-6">
										...
										<p class="font-w600 mb-2 d-flex">
											...
											<select name="political" class="form-control" value="${user.political }">
										...
										<p class="font-w600 mb-2 d-flex">
											...
											<select name="degree" class="form-control" value="${user.degree }">
										...
										<p class="font-w600 mb-2 d-flex">
											...
											<select name="unemployed" class="form-control" value="${user.unemployed }">
									...
									<div class="col-xl-12 col-md-12">
										<p class="font-w600 mb-2 d-flex">
											...
											<select name="experience" class="form-control" value="${user.experience }">
												<option selected>${user.experience }</option>
			                                	<option value="无相关工作经验">无相关工作经验</option>
