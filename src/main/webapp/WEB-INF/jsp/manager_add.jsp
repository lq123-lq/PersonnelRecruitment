				...
				<ul class="metismenu" id="menu">
                    <li class="mm-active"><a class="has-arrow " href="javascript:void()" aria-expanded="true">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="${pageContext.request.contextPath }/addManager" class="mm-active">添加管理员</a></li>
						</ul>
                    </li>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="d-flex align-items-center mb-4 flex-wrap">
					<h4 class="fs-20 font-w600 me-auto">添加管理员账号</h4>
				...
				<div class="row">
					...
					<div style="width: 500px;position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="staffCode" placeholder="请输入教职工编号" _mstplaceholder="7861633">
                            </div>
                            <div class="mb-3">
                                <label class="mb-1"><strong>姓名</strong></label>
                                <input type="text" class="form-control" name="staffName" placeholder="请输入教师姓名" _mstplaceholder="331292">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control solid" name="collegeName">
										  <option selected>Choose...</option>
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary btn-block">添加账号</button>
                            </div>
                     </div>
                     </form>
                     </div>
